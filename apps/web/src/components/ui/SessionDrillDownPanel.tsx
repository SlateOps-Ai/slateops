...
export function SessionDrillDownPanel({ agentId, agentName, onClose }: Props) {
  ...
  return (
    <motion.div
      ...
      className="fixed right-[552px] top-16 bottom-16 z-50 w-96 flex flex-col rounded-2xl border border-white/10 bg-panel-bg shadow-2xl backdrop-blur-sm overflow-hidden"
    >
      {/* Header */}
